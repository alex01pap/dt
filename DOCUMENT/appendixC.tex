...
\begin{lstlisting}[caption={Listing Γ.1: Ενδεικτικός κανόνας \textlatin{NoiseGuard} σε \textlatin{openHAB}},label={lst:noiseguard_rule}]
var int cl1Count = 0
...
\begin{lstlisting}[caption={Listing Γ.2: Ενδεικτικός κανόνας \textlatin{FridgeGuardian} σε \textlatin{openHAB}},label={lst:fridgeguardian_rule}]
