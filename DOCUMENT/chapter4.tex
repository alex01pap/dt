...
\subsection{\texorpdfstring{\textlatin{2D Interactive Floorplans} και \textlatin{live sensor markers}}{2D Interactive Floorplans και live sensor markers}}
...
Η διπλή παρουσία \textlatin{2D} και \textlatin{3D} προβολών είναι στρατηγικής σημασίας. Οι \textlatin{2D} κατόψεις προσφέρουν ταχύτητα και σαφήνεια σε λειτουργικές εργασίες, ενώ η \textlatin{3D} απεικόνιση προσφέρει ανώτερη χωρική κατανόηση και περισσότερο ενοποιημένη αντίληψη του \textlatin{Smart Campus}. Η συνύπαρξη αυτών των δύο μορφών οπτικοποίησης, όπως φαίνεται στο Σχήμα~\ref{fig:3d_2d_visualization}, ενισχύει αισθητά την πρακτική χρηστικότητα της πλατφόρμας.
