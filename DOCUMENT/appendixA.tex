...
\midrule
1 & \textlatin{Raspberry Pi 4 Model B (4GB)} --- Κεντρικός \textlatin{edge server} & 1 & 73,92 & 73,92 \\
2 & \textlatin{ESP32 DevKit (WROOM)} --- Μικροελεγκτής αιθουσών & 3 & 8,07 & 24,21 \\
3 & \textlatin{INMP441 I\textlatin{2}S Digital Microphone} --- Αισθητήρας θορύβου \textlatin{dBA} & 3 & 3,20 & 9,60 \\
4 & \textlatin{ESP8266 NodeMCU} --- Μικροελεγκτής θύρας ψυγείου & 1 & 4,50 & 4,50 \\
5 & \textlatin{Shelly 1PM Mini Gen3} --- Έξυπνος μετρητής ισχύος ψυγείου & 1 & 17,26 & 17,26 \\
6 & \textlatin{Sonoff Basic R2} --- Ενεργοποιητής ρελέ, έλεγχος \textlatin{quiet-lamp} και \textlatin{buzzer} & 4 & 9,90 & 39,60 \\
7 & \textlatin{DS18B20 (Waterproof)} --- Αισθητήρας θερμοκρασίας ψυγείου & 1 & 7,14 & 7,14 \\
8 & \textlatin{DFPlayer Mini MP3 Module} --- Αυτοματισμός κουδουνιού & 1 & 3,50 & 3,50 \\
9 & Μαγνητική Επαφή Θύρας (\textlatin{MC-38}) --- Αισθητήρας κατάστασης θύρας ψυγείου & 1 & 2,50 & 2,50 \\
\midrule
